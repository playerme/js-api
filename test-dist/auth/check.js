...
(0,_mocha.it)('should fail if username does not exist',

function(done){return (0,_utils.shouldFail)((0,_auth.check)({login:nonExistingUsername,password:password}),done);});
...
(0,_auth.check)({login:login,password:password}),
function(user){
