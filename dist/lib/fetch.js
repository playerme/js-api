...
postProcess=postProcess;var _isomorphicFetch=require('isomorphic-fetch');var _isomorphicFetch2=_interopRequireDefault(_isomorphicFetch);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var JSON_HEADERS={Accept:'application/json','Content-Type':'application/json'};var BASE_URL=process.env.BASE_URL||'https://player.me/api/v1';function fetch(endpoint){var config=arguments.length<=1||arguments[1]===undefined?{}:arguments[1];var url=BASE_URL+'/'+endpoint;return (0,_isomorphicFetch2.default)(url,_extends({headers:JSON_HEADERS,method:'GET'},config));}function post(endpoint,args){return fetch(endpoint,{method:'POST',body:JSON.stringify(args)});}function postProcess(response){
var processJSON=function(responseJSON){
