...
(0,_mocha.it)('should fail if code is invalid',

function(done){return (0,_utils.shouldFail)(
(0,_auth.reset)({code:'invalidcode',password:password,confirm:confirm}),
done);});



(0,_mocha.it)('should fail if password and confirm are not the same',

function(done){return (0,_utils.shouldFail)(
(0,_auth.reset)({code:code,password:password,confirm:confirm+1}),
done);});
...
(0,_mocha.it)('should resolve with a success message if successful',

function(done){return (0,_utils.shouldSucceed)(
(0,_auth.reset)({code:code,password:password,confirm:confirm}),
